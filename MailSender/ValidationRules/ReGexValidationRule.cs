...
namespace MailSender.ValidationRules
{
    class ReGexValidationRule : ValidationRule
    {
        ...
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            return _Regex.IsMatch(str) ? ValidationResult.ValidResult : new ValidationResult(false, ErrorMessage ?? $"Строка {str} не удовлетворяет регулярному выражению {Pattern}");
        }
    }
}
